...
PACKAGE=gitlab.ozon.dev/albatros2002/telegram-bot/cmd/bot
...
#	${MOCKGEN} -source=internal/storage/memory_storage/memory_storage.go -destination=internal/mocks/memory_storage/memory_storage_mock.go
